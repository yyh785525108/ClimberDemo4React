...
import {View, ViewPropTypes, Text, Button, StyleSheet} from 'react-native';
...
export default class CircularProgress extends React.PureComponent {
  ...
  render() {
    ...
    const dashedBackgroundStyle =
      dashedBackground.gap > 0 ? dashedBackground : {width: 0, gap: 0};

    const strokeDasharray =
      dashedBackground.gap > 0
        ? Object.values(dashedBackgroundStyle).map((value) => parseInt(value))
        : null;
    ...
    return (
      <View style={styles.progressWholeView}>
        ...
        <View style={styles.details}>
          <Text style={styles.stepTipsText}>Steps</Text>
          <Text style={styles.stepValueText} ref={'stepValue'}>
            {Math.trunc(fill * 40)}
          </Text>
